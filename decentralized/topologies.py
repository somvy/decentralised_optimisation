...
class Topologies:
    ...
    def __init__(self, n, topology_type, matrix_type, n_graphs=None, 
        ...
        assert self.matrix_type in ["mixing-metropolis", "mixing-laplacian", "gossip-metropolis", "gossip-laplacian"]
    ...
    def __graph_to_matrix(self, graphs):
        result = []
        for G in graphs:
            if self.matrix_type == "mixing-metropolis" or self.matrix_type == "gossip-metropolis":
            ...
            if self.matrix_type == "mixing-laplacian" or self.matrix_type == "gossip-laplacian":
            ...
            if self.matrix_type[0] == "g": # gossip matrices
